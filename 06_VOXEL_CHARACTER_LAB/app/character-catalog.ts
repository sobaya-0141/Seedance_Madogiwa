...
export const CHARACTERS: CharacterCatalogEntry[] = [
  ...
  },
  {
    ...
    note: "元画像準拠の顔テクスチャ、黒いフード付きローブ、人間の腕2本、6本の触手を維持。",
    modelUrl: "/models/takosan.glb?v=face-texture-2",
    scale: 1.3,
    rotationY: Math.PI,
    rig: {
      primaryArm: [STANDARD_RIG.primaryArm],
  ...
  },
  {
    ...
    bodyType: "小型・二足",
    rigLabel: "BIPED / 4 PIVOTS",
    note: "元画像準拠の丸メガネ・頬・笑顔を顔テクスチャ化。黒い横分け髪と紫シャツを維持。",
    modelUrl: "/models/yametaro.glb?v=face-texture-2",
    scale: 1.2,
    rotationY: Math.PI,
    rig: standardBipedRig,
    motion: {
